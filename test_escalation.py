...
def test_escalation_3x3():
    ...
    assert result[1] == [[Fraction(-2, 3), Fraction(-4, 3), Fraction(1, 1)],
...
def test_escalation_2x2():
    ...
    matriz = matrixAsker.askMatrix(2, i)
    result = escalation.escalation(matriz)
    assert result[1] == [[Fraction(-5, 3), Fraction(2, 3)], [Fraction(4, 3), Fraction(-1, 3)]]
...
def test_escalation_4x4():
    ...
    result = escalation.escalation(matriz)
    assert result[1] == [[Fraction(-1, 1), Fraction(37, 14), Fraction(-23, 14), Fraction(1, 7)],
