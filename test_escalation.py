...
def test_putZerosInColumn_1():
    ...
    identityMatrix = escalation.makeIdentityMatrix(3)
    augMatrix = augmentedMatrix.AugmentedMatrix(matriz, identityMatrix)
    escalation.putZerosInColumn(augMatrix, 0)      # [Fraction(3, 1), Fraction(4, 1), Fraction(5, 1)]
...
def test_putZerosInColumn_2():
    ...
    escalation.putZerosInColumn(augMatrix, 1)      # [Fraction(3, 1), Fraction(4, 1), Fraction(1, 1)]
...
def test_putZerosInColumn_3():
    ...
    escalation.putZerosInColumn(augMatrix, 2)  # [Fraction(3, 1), Fraction(4, 1), Fraction(1, 1)]
...
def test_putZerosInColumn_5():
    ...
    augMatrix = augmentedMatrix.AugmentedMatrix(matriz, identityMatrix)
    escalation.putZerosInColumn(augMatrix, 0)
...
def test_escalation_4x4():
    numbers = ["0", "1", "0", "3", "0", "0", "2", "4", "0", "0", "0", "5", "0", "0", "0", "0"]
    i = inputFake(numbers)
    ...
    result = escalation.escalationOfAugmentedMatrix(augmentedMatrixExample)
    assert result.firstMatrix() == Matrix([[Fraction(0, 1), Fraction(1, 1), Fraction(0, 1), Fraction(0, 1)],
...
def test_escalation_4x4_makePivotOnColumn_0():
    ...
    escalation.makePivotOnColumn(augMatrix, 0)
...
def test_escalation_4x4_makePivotOnColumn_0_plus_putZerosInColumn():
    ...
    escalation.makePivotOnColumn(augmentedMatrixExample, 0)
    escalation.putZerosInColumn(augmentedMatrixExample, 0)
...
def test_escalation_4x4_makePivotOnColumn_1():
    ...
    escalation.makePivotOnColumn(augmentedMatrixExample, 0)
    escalation.putZerosInColumn(augmentedMatrixExample, 0)
    escalation.makePivotOnColumn(augmentedMatrixExample, 1)
...
def test_escalation_4x4_makePivotOnColumn_1_plus_putZerosInColumn():
    ...
    escalation.putZerosInColumn(augmentedMatrixExample, 0)
    escalation.makePivotOnColumn(augmentedMatrixExample, 1)
    escalation.putZerosInColumn(augmentedMatrixExample, 1)
...
def test_escalation_4x4_makePivotOnColumn_2():
    ...
    escalation.makePivotOnColumn(augmentedMatrixExample, 1)
    escalation.putZerosInColumn(augmentedMatrixExample, 1)
    escalation.makePivotOnColumn(augmentedMatrixExample, 2)
...
def test_escalation_4x4_makePivotOnColumn_2_plus_putZerosInColumn():
    ...
    escalation.putZerosInColumn(augmentedMatrixExample, 1)
    escalation.makePivotOnColumn(augmentedMatrixExample, 2)
    escalation.putZerosInColumn(augmentedMatrixExample, 2)
